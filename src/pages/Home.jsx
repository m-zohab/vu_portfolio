...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="section-container">
            ...
            {services.map((service, index) => {
              ...
              return (
                <Reveal key={service.id} delay={index * 60}>
                  <div className="flex h-full flex-col gap-3 rounded-2xl border border-ink-100 bg-paper p-6 transition-all duration-300 hover:-translate-y-1 hover:border-ink-200 hover:shadow-card">
          ...
          <Reveal delay={200} className="mt-10 flex justify-center">
            <Link
              to="/services"
              className="inline-flex items-center gap-2 rounded-full border border-ink-200 bg-white px-6 py-3 text-sm font-semibold text-ink-700 transition-colors hover:border-ink-400 hover:text-ink-900"
            >
              See all services
              <ArrowRight size={16} />
            </Link>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="section-container grid items-center gap-10 lg:grid-cols-2">
          <Reveal direction="left">
            ...
            <Link
              to="/viva-preparation"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-ink-700 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-ink-800"
            >
              How viva prep works
              <ArrowRight size={16} />
            </Link>
          ...
          <Reveal direction="right" delay={120}>
            <div className="rounded-2xl border border-ink-100 bg-paper-deep p-8">
      ...
      <section className="bg-gradient-to-br from-gold-100 via-paper to-ink-50 py-16 lg:py-20">
        <div className="section-container">
          <Reveal className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-ink-100 bg-white/70 p-8 backdrop-blur sm:flex-row sm:items-center sm:p-10">
            <div>
