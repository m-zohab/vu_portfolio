...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-16 hidden whitespace-nowrap rounded-lg border border-slate-100 bg-white px-3 py-2 text-xs font-medium text-slate-700 opacity-0 shadow-soft transition-opacity duration-200 group-hover:opacity-100 sm:block">
        Chat with us
      </span>
    </a>
  );
